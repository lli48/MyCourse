...
By calculating the first and second derivative of l with respect to $\beta$, we can derive the formula for N-R method: ($W = diag(\mu_i)$)
...
### GLM in R
In R, we can use the function glm() to fit the model. 
